        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Neighborhood stories worth reading
            </h2>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <a className="mb-2 block max-w-full" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Makati's rise as the financial heart
                </h2>
              </a>
              <p>
          ...
          <div className="flex size-full flex-col items-center justify-start border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <a className="mb-2 block max-w-full" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Cebu City's transformation into a modern hub
                </h2>
              </a>
              <p>
          ...
          <div className="flex size-full flex-col items-center justify-start border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <a className="mb-2 block max-w-full" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Why Davao attracts serious investors and families
                </h2>
              </a>
              <p>
